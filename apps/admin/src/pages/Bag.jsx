...
const Bag = () => {
  ...
  const suggestedItems = [
    { id: 6, name: 'EMBER TEXTURED SHIRT', price: 2199, image: '/signature_zip_hoodie_1785054724510.png' },
    { id: 7, name: 'SHADOW GRAPHIC TEE', price: 1699, image: '/raven_hoodie_back_1785054706044.png' },
    { id: 8, name: 'JATAYU CAP - OLIVE', price: 799, image: '/signature_zip_hoodie_1785054724510.png' },
    { id: 9, name: 'VERTICAL LOGO HOODIE', price: 2799, image: '/raven_hoodie_back_1785054706044.png' },
  ];
                ...
                <div key={`${item.id}-${item.size}-${index}`} className="bag-item">
                    ...
                    <div className="item-details">
                      ...
                      <p className="item-color">
                        {item.colors && item.colors[0] && (
                          <span className="color-dot" style={{backgroundColor: item.colors[0]}}></span>
                        )}
                        Selected
                      </p>
                    </div>
                  ...
                  <div className="col-total item-total">
                    ...
                    <div className="item-actions">
                      <button className="remove-btn" onClick={() => removeFromCart(item.id, item.size)}>🗑️ Remove</button>
                    </div>
                  </div>
                </div>
              ))}
